...
const api = {
  ...
  previewMcpHandoff: (): Promise<McpHandoffPayload> => ipcRenderer.invoke('mcp:previewHandoff'),
  ...
  exportLibraryMarkdown: (): Promise<LibraryMarkdownExportResult> => ipcRenderer.invoke('library:exportMarkdown'),
  importLibraryMarkdown: (): Promise<LibraryMarkdownImportResult> => ipcRenderer.invoke('library:importMarkdown'),
